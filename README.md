UEDI_Universal_Embedded_Debian_Installer
========================================

THIS README IS STILL A PRELIMINARY VERSION! NOT ALL FUNCTIONS ARE DESCRIBED, YET!
...
Created in scope of the Master thesis, winter semester 2013/2014 under the supervision of Professor Hubert Högl, at the University of Applied Sciences Augsburg.
...
<h2>ATTENTION:</h2>
<ol>
<li>A <b>SERIAL CONNECTION</b> to the device is <b>HIGHLY RECOMMENDED</b> for this procedure.<br><i><b>Debugging is more or less impossible without it!</b></i></li><br>
...
README: Universal Embedded Debian Installer (UEDI)
--------------------------------------------------
...
- **general_settings.sh**: File for all the settings and configurations that any machine needs. Here you define what the output of the scripts will look like.

- **machine_settings.sh**: File for all settings and configurations that are purely machine specific. Here you define what the output of the scripts will look like.

- **machine_funtions.sh** : This file includes the machine specific build and some helper funtions.
